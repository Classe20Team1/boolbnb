                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="birthdate" type="date" min="1900-01-01" max="{{ date('Y-m-d') }}" class="form-control @error('birthdate') is-invalid @enderror" name="birthdate" value="{{ old('birthdate') }}" required autocomplete="birthdate" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="fiscal_code" type="text" class="form-control @error('fiscal_code') is-invalid @enderror" name="fiscal_code" value="{{ old('fiscal_code') }}" required autocomplete="fiscal_code" autofocus>
